...
<article>
    ...
    <address class="norm">
        <h4>
            {{$ventas->clie_nombre . ' ' . $ventas->clie_apellido}}
        </h4>
    ...
    <br>
    <br>
    <buttom onclick = "window.print();"class="btn btn-primary">Imprimir</buttom>
    <br>
    <buttom onclick = "window.close.href='{{route('ventas.index')}}';" class="btn btn-primary">Cerrar</buttom>
</article>
</body>
</html>
